...
########################################################
# Install free5gc installer to VM
########################################################
async def run_install(namespace, upf_vm_name):
    logger.debug("installing builder for free5gc")
    ...
    r = ansible_runner.run(private_data_dir=constants.basedir+"/free5gc/build/playbooks", 
                           inventory={'all': hosts},
