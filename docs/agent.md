...
![agent architecture](/docs/drawings/agent/agent_architecture.drawio.svg)
...
![agent hierarchy](/docs/drawings/agent/chatagents.drawio.svg)
...
![chat interaction](/docs/drawings/agent/chatinteraction.drawio.svg)
...
![background](/docs/drawings/agent/background.drawio.svg)
...
![agent interaction](/docs/drawings/agent/background-sequence.drawio.svg)
...
![main agent architecture](/docs/drawings/agent/main_agent.drawio.svg)
...
![engineer agent architecture](/docs/drawings/agent/engineer.drawio.svg)
...
![fault trigger](/docs/drawings/agent/faulttrigger.drawio.svg)
...
![fault agent](/docs/drawings/agent/resolver_agent.drawio.svg)
