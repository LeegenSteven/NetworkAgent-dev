...
import os
import json
from graph.topology import build_graph, spanner_connect
from agent.tools.metrics import fetch_all_last_metrics
from agent.tools.logs import fetch_log_entries
    ...
    while True:
        try:
            ...
            for sid, state in clients_state.items():
                ...
                logger.info("Sent topology update to all clients")
