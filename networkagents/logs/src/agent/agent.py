...
class LogsAgent:
    ...
    async def get_instance(cls):
        if LogsAgent._instance is None:
            ...
            await LogsAgent._instance.load_tools()
        return LogsAgent._instance

    def __init__(self):
        logger.info("starting logs agent")

        self.credentials = get_credentials()

        workflow = StateGraph(LogsAgentState)
    ...
    async def load_tools(self):
        ...
        try:
            ...
            allowed_tools_names=["query_log_entries"]
            # load all tools
    ...
    async def call_model(self, state: LogsAgentState):
        """
        Run the model
        """
        logger.info("run logs agent helper")
    ...
    async def should_run_tool(self, state: LogsAgentState):
    ...
    async def tool_node(self, state: LogsAgentState):
        """
        Call logs agent tools and return output
        """
