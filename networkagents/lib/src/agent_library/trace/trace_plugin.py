...
class TracePlugin(BasePlugin):
    ...
    def __init__(self) -> None:
        ...
        logger.info("init pub sub plugin")
    ...
    def _write_to_spanner(self, event):
        ...
        logger.info(f"   📝 Written to Spanner: {event['id']}")
    ...
    def handle_start(self, event_type, name, details=None):
        ...
        logger.info(f"   Trace: {trace_id} | Span: {current_span_id} | Parent: {parent_span_id}")
    ...
    def handle_end(self, event_type, name, details=None):
        ...
        logger.info(f"   Published and popped span")
